  ...
  return (
    ...
    >
      <SidebarHeader className={cn(
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild className={cn(
              ...
              <LocalizedNavLink to="/">
                <div className={cn(
                  ...
                  {/* Animated shine effect - only in light mode */}
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700 rounded-lg dark:via-transparent" />
                </div>
